        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorsImage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PoductImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SermonType = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "adeyemieyinjuoluwa@gmail.com", "$2a$11$XAnMqCKFeQAOsPF4/ybQUutixvi46z9Mfstl/GezbCbZKgv9wnj8." });

            migrationBuilder.InsertData(
                table: "Members",
                columns: new[] { "Id", "Email", "FirstName", "LastName", "UserId" },
                values: new object[] { 1, "adeyemieyinjuoluwa@gmail.com", "Adeyemi", "Adebisi", 1 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sermons_MemberId",
                table: "Sermons",
                column: "MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_Sermons_PreacherId",
                table: "Sermons",
                column: "PreacherId");
